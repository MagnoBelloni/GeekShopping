...
namespace GeekShopping.Web.Controllers
{
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> ApplyCoupon(CartViewModel model)
        {
            ...
            var applyCouponVO = new ApplyCouponViewModel()
            {
                CouponCode = model.CartHeader.CouponCode,
                UserId = model.CartHeader.UserId
            };

            var response = await _cartService.ApplyCoupon(applyCouponVO, token);
        ...
        {
            var token = await HttpContext.GetTokenAsync("access_token");
            model.CartHeader.CartDetails = new List<CartDetailViewModel>();
